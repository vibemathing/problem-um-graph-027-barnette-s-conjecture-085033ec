...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-graph-027-barnette-s-conjecture-085033ec-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/GRAPH-027"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-graph-027-barnette-s-conjecture-085033ec-v1",
      "problem_contract_sha256": "c524f66548918d02535c77d857c05e0beeeb8eae145dbc529c9c53aecb106611",
      "problem_id": "problem:um-graph-027-barnette-s-conjecture-085033ec",
      "route_id": "route:um-graph-027-barnette-s-conjecture-085033ec-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-graph-027-barnette-s-conjecture-085033ec-source-fidelity-01",
      "graph_id": "graph:um-graph-027-barnette-s-conjecture-085033ec-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-graph-027-barnette-s-conjecture-085033ec-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-graph-027-barnette-s-conjecture-085033ec-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Does every cubic bipartite three-connected planar graph have a Hamiltonian cycle?"
          },
          "statement_sha256": "25bf9ad85e9594d3fb376ad4d4273530980d77cc96657ec2c77ace174f69712c"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-graph-027-barnette-s-conjecture-085033ec-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-graph-027-barnette-s-conjecture-085033ec-root",
      "route_id": "route:um-graph-027-barnette-s-conjecture-085033ec-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-graph-027-1a85623ac68a",
        "url": "https://www.unsolvedmath.com/problems/GRAPH-027"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
